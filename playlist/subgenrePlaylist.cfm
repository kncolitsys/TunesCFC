<cfscript>
	...
	subGenreId = "";
	subGenrePlaylist =  playlistServices.getNewPlaylists();
	if(isDefined("url.subGenreId")){
		subGenrePlaylist  = playlistServices.getAllPlaylistBySubgenreId(url.subGenreId);
	}
</cfscript>
<cfoutput>
<table cellspacing="15" border="0" class="playlistTable">
	<cfloop array="#subGenrePlaylist#" index="playlist">
		<tr>
